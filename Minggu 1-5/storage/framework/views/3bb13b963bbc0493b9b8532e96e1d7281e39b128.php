        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('backend/img/avatar-mini.jpg')); ?>"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('backend/img/avatar-mini2.jpg')); ?>"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('backend/img/avatar-mini3.jpg')); ?>"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('backend/img/avatar-mini4.jpg')); ?>"></span>
                                    <span class="subject">
...
<?php /**PATH C:\xampp\htdocs\E32201197_Mirzando\BelajarLaravel\resources\views/backend/layouts/template.blade.php ENDPATH**/ ?>